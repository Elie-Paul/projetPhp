 ...
 */
final class Version20190214134934 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE abonnement (id INT AUTO_INCREMENT NOT NULL, compteur_id INT DEFAULT NULL, contrat VARCHAR(200) NOT NULL, date DATETIME NOT NULL, cumul_anc DOUBLE PRECISION DEFAULT NULL, cumul_nouv DOUBLE PRECISION DEFAULT NULL, UNIQUE INDEX UNIQ_351268BBAA3B9810 (compteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE facture (id INT AUTO_INCREMENT NOT NULL, abonnement_id INT NOT NULL, mois VARCHAR(200) NOT NULL, consomation DOUBLE PRECISION NOT NULL, prix INT NOT NULL, reglement TINYINT(1) NOT NULL, INDEX IDX_FE866410F1D74413 (abonnement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
